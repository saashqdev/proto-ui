...
<div style="position: relative; z-index: 1; height: 500px; overflow: hidden;">
    <l-page demo>
        <u-navbar slot="head">
            ...
            <u-navbar-item href="/">Home</u-navbar-item>
            ...
            <u-navbar-item href="https://github.com/saashqdev/kubevue-templates/admin-cloud-fs" target="_blank">GitHub</u-navbar-item>
            <div slot="right">
...
Use `<l-page-center>` to constrain the content to the center area.

The following example sets the size="small" attribute for ease of presentation.
    ...
    <l-page demo>
        <l-page-center size="small" slot="head">
            <u-navbar>
                ...
                <u-navbar-item href="/">Home</u-navbar-item>
                <u-navbar-item href="https://kubevue.github.io" target="_blank">Kubevue</u-navbar-item>
                <u-navbar-item href="https://github.com/vusion/cloud-ui" target="_blank">Component Library</u-navbar-item>
                <div slot="right">
                    <u-navbar-dropdown style="width: 100px; margin-right: 10px;">
                        <div slot="title">User</div>
                        <u-navbar-menu>
...
Use `<l-page-section>` to quickly add a section.
...
| --------- | ---- | ------- | ------- | ----------- |
| size | enum | `'mini'`, `'small'`, `'normal'`, `'large'`, `'huge'` | `'normal'` | The width size. |
